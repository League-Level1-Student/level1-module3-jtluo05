...
frame.setVisible(true);
		...
		frame.setTitle("Jordans Genuis Jeoparty");
...
playJeopardyTheme();
		...
		if (buttonPressed==firstButton) {
			askQuestion("What is the fastest animal in the world?", "Peregrine Falcon", 200);
		}
		...
		// Or if the buttonPressed was the secondButton
			...
			askQuestion("What is the longest living animal in the world?", "Tortoise", 400);
		}
...
if (answer.equalsIgnoreCase(correctAnswer)) {
			...
			JOptionPane.showMessageDialog(null, "YOU ARE RIGHT!!!!! COUNGRATULATIONS!!!!"
					+ "YOU JUST WON $"+ prizeMoney+" !");
		}
		...
		else {	score=score-prizeMoney;
			// Pop up a message to tell the user the correct answer
			JOptionPane.showMessageDialog(null, "Oh no! Your are wrong. The correct answer was "+correctAnswer+".");
			// Call the updateScore() method
			updateScore();
		}		
